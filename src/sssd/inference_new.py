...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='/home/anamikumari/MGB-MAIDAP/models/SSSD-ECG/src/sssd/config/SSSD_ECG_demographic_cond_interpolate_15_onehot_mimic_faster-hyperparameter-mimic-inf.json',
                        help='JSON file for configuration')
    parser.add_argument('-ckpt_iter', '--ckpt_iter', default=165000,
