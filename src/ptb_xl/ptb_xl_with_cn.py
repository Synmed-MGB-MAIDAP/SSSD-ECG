...
def parse_args():
    ...
    parser.add_argument(
        "--embedding_path",
        type=str,
        default="/home/kumargirish/data/ptbxl/ptbxl_text_embed_with_reduced.csv",
    ...
    parser.add_argument(
        "--data_folder_ptb_xl",
        type=str,
        default="/home/kumargirish/data/ptbxl/1.0.3",
        help="Path to the PTB-XL data folder",
    )
    parser.add_argument(
        "--base_target_folder_ptb_xl",
        type=str,
        default="/home/kumargirish/data/ptbxl/processed",
