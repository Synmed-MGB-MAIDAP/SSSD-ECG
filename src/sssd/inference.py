...
def generate(output_directory,
    ...
    real_data = np.load(os.path.join(label_path, f'{trainset_config["finetune_dataset"]}_{inference_split}_data.npy'))
    labels = np.load(os.path.join(label_path, f'{trainset_config["finetune_dataset"]}_{inference_split}_labels.npy'))
    
    print("Loaded data from ", os.path.join(label_path, f'{trainset_config["finetune_dataset"]}_{inference_split}_data.npy'))
